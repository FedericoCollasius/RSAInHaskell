...
-- CORRECCIÓN: es mejor pasarle directamente el m como parámetro ya que el p y q
-- no se usan por separado dentro de la función. Además, te sirve para reusarlo
-- en la línea donde definís d (en generarClaves).
